...
\graphicspath{{build/simulation_results/}}
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=0.75\linewidth]{T1_random_sync_histogram}
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=0.75\linewidth]{T2_twopeaks_sync_histogram}
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=0.75\linewidth]{T3_alloutside_sync_histogram}
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=0.75\linewidth]{T4_oscillation_demo_histogram}
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=0.75\linewidth]{T1_random_sync_phase\\[4pt]
  \includegraphics[width=0.75\linewidth]{T1_random_sync_temporal}
  \caption{T1 -- Phase alignment and temporal evolution.}
\end{figure}

\begin{figure}[htbp!]
  \centering
  \includegraphics[width=0.75\linewidth]{T2_twopeaks_sync_phase}\\[4pt]
  \includegraphics[width=0.75\linewidth]{T2_twopeaks_sync_temporal}
  \caption{T2 -- Phase alignment and temporal evolution.}
\end{figure}

\begin{figure}[htbp!]
  \centering
  \includegraphics[width=0.75\linewidth]{T3_alloutside_sync_phase}
  \caption{T3 -- Phase alignment. Temporal evolution omitted for brevity.}
\end{figure}

\begin{figure}[htbp!]
  \centering
  \includegraphics[width=0.75\linewidth]{T4_oscillation_demo_phase}\\[4pt]
  \includegraphics[width=0.75\linewidth]{T4_oscillation_demo_temporal}
